...
uint16_t pulsePerRevolution = 932.8; //11*2*2*21.3=932.8 for 2 encoders with 11 pulses. quadrature means times another 2 and gear reduction is 21.3
...
void getSpeed(Encoder encNumber)
{
    ...
    if (millis() - enc_timer > 50)
    {
        if (newPosition != oldPosition)
        {
            ...
            //Serial.println(newPosition / 0.05 * 60.0 / pulsePerRevolution * 20.42035225);
